...
# xcodebuild -exportArchive -archivePath Archive/$PROJECT_NAME.xcarchive -exportPath Product/$PROJECT_NAME.app -exportFormat app -exportOptionsPlist ${PROJECT_DIR}/${INFOPLIST_FILE}

cp -R Archive/$PROJECT_NAME.xcarchive/Products/Applications/$PROJECT_NAME.app Product/$PROJECT_NAME.app
